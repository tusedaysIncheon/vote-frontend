...
const isLoggedIn = false; // 나중에 store나 JWT로 대체
...
function Layout() {
  ...
  const navOffset = isLoggedIn ? USER_NAV_HEIGHT : isGuestPage ? GUEST_NAV_HEIGHT : 0
  ...
  return (
    <>
      ...
      {/* Navbar */}
      {isLoggedIn ? <NavbarUser /> : isGuestPage && <NavbarGuest />}
